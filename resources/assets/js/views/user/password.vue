        ...
        <div class="row">
            <div class="col-12 col-lg-8 col-md-8">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <user-sidebar menu="password" :type="type" :id="id"></user-sidebar>
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            if(!helper.hasPermission('force-reset-password-'+this.type)){
        ...
        methods: {
            submit(){
                this.passwordForm.patch('/api/user/'+this.type+'/'+this.id+'/force-reset-password')
                    .then(response => {
