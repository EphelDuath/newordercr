        ...
        <div class="row">
            <div class="col-12 col-lg-8 col-md-8">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <user-sidebar menu="email" :type="type" :id="id"></user-sidebar>
...
<script>
    ...
    export default {
        ...
        mounted(){
            ...
            if(!helper.hasPermission('email-'+this.type)){
            ...
            axios.get('/api/email-template/'+this.type+'/lists')
                .then(response => response.data)
                .then(response => {
        ...
        methods: {
            ...
            submit(){
                this.emailForm.patch('/api/user/'+this.type+'/'+this.id+'/email')
                    .then(response => {
