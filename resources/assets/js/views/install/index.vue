    ...
    <section id="wrapper">
        <div class="install" style="background-image:url(/images/background.jpg);">
            <div class="install-box card" v-show="!is_processing">
                <form-wizard color="#55CE63" title="Mint Invoice Manager" :subtitle="trans('install.sub_title')" :nextButtonText="trans('install.next_button_content')" :backButtonText="trans('install.back_button_content')" :finishButtonText="trans('install.finish_button_content')" @on-complete="finishInstallation">
