<template>
    <div class="col-2 col-lg-2 col-md-2">
        <div class="list-group">
            ...
            <router-link to="/configuration/permission" :class="[menu === 'permission' ? 'active' : '', 'list-group-item']"><span class="hidden-sm-up"><i class="fas fa-key"></i></span> <span class="hidden-xs-down">{{trans('permission.permission')}}</span> </router-link>
            ...
            <router-link to="/configuration/authentication" :class="[menu === 'authentication' ? 'active' : '', 'list-group-item']"><span class="hidden-sm-up"><i class="fas fa-sign-in-alt"></i></span> <span class="hidden-xs-down">{{trans('auth.authentication')}}</span> </router-link>
            <router-link to="/configuration/payment-gateway" :class="[menu === 'payment-gateway' ? 'active' : '', 'list-group-item']"><span class="hidden-sm-up"><i class="fas fa-credit-card"></i></span> <span class="hidden-xs-down">{{trans('payment.payment_gateway')}}</span> </router-link>
