        ...
        <div class="card-body">
            <div class="row">
                <div class="col-12 col-lg-6 col-md-6 col-sm-6">
                    <h4 class="card-title">{{trans('quotation.email')}}</h4>
...
<script>
    ...
    export default {
        ...
        watch: {
            showPanel(val){
                if(val){
                    this.getQuotationEmailTemplate();
                    this.getEmailLogs();
                }
            }
        },
        ...
        methods: {
            getQuotationEmailTemplate(){
                ...
                axios.get('/api/email-template/quotation/lists')
            ...
            getTemplateContent(selectedOption){
                ...
                axios.get('/api/email-template/'+selectedOption.id+'/content?quotation_uuid='+this.uuid)
                    .then(response => response.data)
                    .then(response => {
            ...
            sendEmail(){
                this.emailForm.post('/api/quotation/'+this.uuid+'/email')
                    .then(response => {
            ...
            getEmailLogs(page){
                ...
                axios.get('/api/quotation/'+this.uuid+'/email-log?page=' + page + url)
                    .then(response => response.data)
            ...
            fetchEmailDetail(email_log){
                axios.post('/api/quotation/'+this.uuid+'/email-detail',{
                        id: email_log.id
                    })
                    .then(response => response.data)
                    .then(response => {
