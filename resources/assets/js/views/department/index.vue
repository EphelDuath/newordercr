            ...
            <div class="col-12 col-sm-8 col-md-8" v-if="hasPermission('list-department')">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="order" class="form-control" v-model="filterDepartmentForm.sort_by">
                ...
                <div class="card">
                    <div class="card-body">
                                ...
                                <tbody>
                                    <tr v-for="department in departments.data">
                                        ...
                                        <td class="table-option">
                                            <div class="btn-group">
                                                <button class="btn btn-info btn-sm" v-if="hasPermission('edit-department')" v-tooltip="trans('department.edit_department')" @click.prevent="editDepartment(department)"><i class="fas fa-edit"></i></button>
                        ...
                        <module-info v-if="!departments.total" module="department" title="module_info_title" description="module_info_description" icon="university"></module-info>
