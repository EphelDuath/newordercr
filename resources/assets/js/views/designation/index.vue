            ...
            <div class="col-12 col-sm-8 col-md-8" v-if="hasPermission('list-designation')">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="order" class="form-control" v-model="filterDesignationForm.sort_by">
                ...
                <div class="card">
                    <div class="card-body">
                                ...
                                <tbody>
                                    <tr v-for="designation in designations.data">
                                        ...
                                        <td class="table-option">
                                            <div class="btn-group">
                                                <button class="btn btn-info btn-sm" v-if="hasPermission('edit-designation')" v-tooltip="trans('designation.edit_designation')" @click.prevent="editDesignation(designation)"><i class="fas fa-edit"></i></button>
                        ...
                        <module-info v-if="!designations.total" module="designation" title="module_info_title" description="module_info_description" icon="sitemap"></module-info>
