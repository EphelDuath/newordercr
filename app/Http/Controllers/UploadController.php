...
class UploadController extends Controller
{
    ...
    public function fetch()
    {
        ...
        return $this->ok($this->upload->filterByModule(request('module'))->filterByModuleId(request('module_id'))->get());
    }
